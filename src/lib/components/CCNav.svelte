<script lang="ts">
	...
	const dailyStages = [
		{ name: '迷雾战区', m: 9, d: 28, href: '迷雾战区_12-1' },
		{ name: '迷雾战区', m: 9, d: 29, href: '迷雾战区_12-1' },
		{ name: '尚蜀山道', m: 9, d: 30, href: '尚蜀山道_12-1' },
		{ name: '盐风溶洞', m: 10, d: 1, href: '盐风溶洞_12-1' },
		{ name: '伦蒂尼姆边缘区块', m: 10, d: 2, href: '伦蒂尼姆边缘区块_12-1' },
		{ name: '小丘郡物流站', m: 10, d: 3, href: '小丘郡物流站_12-1' },
		{ name: '在建沙滩', m: 10, d: 4, href: '在建沙滩_12-1' },
		{ name: '冻原矿场', m: 10, d: 5, href: '冻原矿场_12-1' },
		{ name: '盐风溶洞', m: 10, d: 6, href: '盐风溶洞_12-2' },
		{ name: '伦蒂尼姆边缘区块', m: 10, d: 7, href: '伦蒂尼姆边缘区块_12-2' },
		{ name: '小丘郡物流站', m: 10, d: 8, href: '小丘郡物流站_12-2' },
		{ name: '在建沙滩', m: 10, d: 9, href: '在建沙滩_12-2' },
		{ name: '冻原矿场', m: 10, d: 10, href: '冻原矿场_12-2' },
		{ name: '迷雾战区', m: 10, d: 11, href: '迷雾战区_12-2' }
	];
