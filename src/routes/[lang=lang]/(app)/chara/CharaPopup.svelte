...
<div class="overlay" class:visible={$selectedChara}>
	...
	>
		...
		{#if $selectedChara}
			...
			<div>
				<div class="grid grid-cols-[180px_1fr] gap-x-2 px-1 mt-3">
					<div />
					<div class="flex items-center justify-evenly mb-3 select-none">
					...
					<div
						class="flex flex-col items-center justify-center pl-3 pr-3 rounded bg-[#161616] bg-opacity-80"
					>
						<div class="flex items-center justify-center h-full">
							<RangeParser rangeId={$selectedChara.stats.rangeId} />
						</div>
						<p class="pb-3">{translations[language].attack_range}</p>
					</div>
