const stagesList = [
  ...
  },
  {
    ...
    enemies: [
      ...
      },
      {
        ...
        prefabKey: "enemy_1072_dlancer_2",
        level: 0,
        min_count: 5,
        max_count: 5,
        elite_min_count: 5,
  ...
  },
  {
    ...
    enemies: [
      ...
      },
      {
        ...
        prefabKey: "enemy_1067_snslime_2",
        level: 0,
        min_count: 0,
        max_count: 0,
        elite_min_count: 0,
          ...
          special: {
            sea_reaper_awaken: {
              tooltip: {
                ...
                zh: [
                  "处于待命状态时，无法攻击/触发技能，低于99.99%时苏醒",
                  "临战状态下，移动速度提升500%，每秒流失最大生命值*$2%$的生命值，每秒对半径2.5范围内所有我方单位造成攻击力20%的神经损伤（该效果无视迷彩）"
                ]
              }
            }
          }
  ...
  },
  {
    ...
    enemies: [
      {
        id: "enemy_1106_byokai_b",
        prefabKey: "enemy_1106_byokai",
        level: 0,
        min_count: 0,
        max_count: 0,
        elite_min_count: 0,
  ...
  },
  {
    ...
    description_ja: "寒さも凍結も自然現象にすぎない。それを克服することもできないのなら、常識を超えた北地の敵に挑むことなど大地は許さないだろう。\n<@rolv.rem><「サーミの意志」>は【自然の奔流】を発動しない。戦場に敵味方全員を寒冷状態にする<降雪>が発生する。<積雪の銀樹>の最大HPが大幅に上昇\nこのスポットは常に通常探査状態であり、ほかのタイプのスポットに変更できない</>",
    description_en: "Cold and ice are merely manifestations of nature. How can the land invite you to face the unconventional enemy in the north if you can't even overcome this? \n<@rolv.rem>[Surge of Nature] becomes a <Blizzard> that inflicts Cold throughout the entire map, <Silvernwhite Bulwark> gain increased HP \nThis node will always be in a regular state and node type cannot be changed</>",
    addInfo_zh: [
  ...
  },
  {
    ...
    name_zh: "虚无之偶",
    name_ja: "虚無の偶像",
    name_en: "Hollow_Visage",
    description_zh: "无论这位萨米英雄曾有何种夙愿，如今，他都只是一个剥离本我后坍缩的表征——正如他身后那万千乌萨斯人一般。\n<@rolv.rem>此处将一直处于标准勘察状态，且无法被改变节点类型</>",
    description_ja: "このサーミの英雄がかつて抱いていた願いが何であろうと、今の彼はその背後にいる無数のウルサス人と同じく、自我を剥奪された崩壊の象徴に過ぎない。\n<@rolv.rem>このスポットは常に通常探査状態であり、ほかのタイプのスポットに変更できない</>",
    description_en: "No matter what long-cherished aspirations this Sami hero once had, he is now but a collapsed symbol stripped of his self—just like the thousands of Ursus behind him. \n<@rolv.rem>This node will always be in a regular state and node type cannot be changed</>",
    addInfo_zh: null,
    addInfo_ja: null,
    addInfo_en: null,
    eliteDesc_zh: null,
  ...
  },
  {
    ...
    description_ja: "見開かれた空虚な目は、この次元のすべてを観察している。そしてその目が閉じられた時にだけ、人々は果ての向こうに広がる秘密を垣間見る機会を得られるのだ。\n<@rolv.rem>このスポットは常に通常探査状態であり、ほかのタイプのスポットに変更できない</>",
    description_en: "It opens its vacuous eye, examining everything in this dimension. Only when the eye shuts will humanity get to chance a glimpse at the secret beyond the ends of the earth. \n<@rolv.rem>This node will always be in a regular state and node type cannot be changed</>",
    addInfo_zh: [
  ...
  },
  {
    ...
    name_zh: "时光之沙",
    name_ja: "時の砂",
    name_en: "Sands_of_Time",
    description_zh: "在这万物的终点，时间与空间都失去了意义，只余两位王者，两支军队以及一场无尽的争斗。\n<@rolv.rem>此处将一直处于标准勘察状态，且无法被改变节点类型</>",
    description_ja: "すべての終着点たるこの場所では、時間も空間も意味を持たず、二人の王者と彼らの兵士が終わりなき戦を繰り広げている。\n<@rolv.rem>このスポットは常に通常探査状態であり、ほかのタイプのスポットに変更できない</>",
    description_en: "At the end of all existence, time and space have lost meaning, leaving two kings, two armies, and an endless struggle. \n<@rolv.rem>This node will always be in a regular state and node type cannot be changed</>",
    addInfo_zh: null,
    addInfo_ja: null,
    addInfo_en: null,
    eliteDesc_zh: null,
  ...
  },
  {
    ...
    name_zh: "迈入永恒",
    name_ja: "永遠へと踏み入る",
    name_en: "Enter_Eternity",
    description_zh: "时间的注脚被抽去，战争就此没有结果。他们的战争还会持续下去，你又将何去何从？\n<@rolv.rem>此处将一直处于标准勘察状态，且无法被改变节点类型</>",
    description_ja: "時間と言う名の脚注が取り除かれ、二人の戦いはいつまでも続くこととなった。しかし、そこに立ち会ったあなたの運命や如何に……\n<@rolv.rem>このスポットは常に通常探査状態であり、ほかのタイプのスポットに変更できない</>",
    description_en: "The footnotes of time have been removed, and the strife bears no fruit. Their war will continue on, but where will you go? \n<@rolv.rem>This node will always be in a regular state and node type cannot be changed</>",
    addInfo_zh: null,
    addInfo_ja: null,
    addInfo_en: null,
    eliteDesc_zh: null,
  ...
  },
  {
    ...
    name_zh: "黄沙幻境",
    name_ja: "黄砂の幻境",
    name_en: "Illusions_In_The_Sand",
    description_zh: "还没等你反应过来，女妖已把你置入了大风肆虐的沙漠中心。远方，黄金花园与赤红军帐若隐若现。\n<@rolv.rem>场地中有随机方向的<沙尘暴>，但提供<加固装置>用来加固<土石结构>，与开启时敌方隐匿效果失效的<侦测器></>",
    description_ja: "気付けばあなたは、バンシーによって風が吹き荒れる砂漠の真ん中に置き去りにされていた。遠くには、黄金の花園と赤い天幕がかすかに見えている。\n<@rolv.rem>戦場にはランダム方向の<砂嵐>が存在する一方で、<土石構造>を補強できる<補強装置>と発動することで敵のステルス状態を解除できる<探知機>が用意されている</>",
    description_en: "The Banshee doesn't wait for your response before placing you in the heart of a desert devastated by the winds. In the distance, a golden garden seems to appear with scarlet army tents. \n<@rolv.rem>A <Sandstorm> will be blowing in a random direction, but <Reinforcement Devices> can reinforce <Dirt Mounds> to make them immune to the effects of sandstorms. This stage also has a <Detector> that can disable the Invisibility effect of nearby enemies</>",
    addInfo_zh: [
      "沙尘暴 - 方向是随机的（4选1）",
  ...
  },
  {
    ...
    name_zh: "亘古仇敌",
    name_ja: "古よりの仇敵",
    name_en: "Ancient_Enemies",
    description_zh: "古老噩梦从门的另一头显现，而且一来就是三个。",
    description_ja: "古の悪夢が門の向こうから現れた。それだけならまだしも、奴らは一度に三体も訪れたのだ。",
    description_en: "Ancient nightmares appear from the gate, and there are three of them.",
    addInfo_zh: null,
    addInfo_ja: null,
    addInfo_en: null,
    eliteDesc_zh: null,
  ...
  },
  {
    ...
    name_zh: "事不过四",
    name_ja: "四度目は無し",
    name_en: "No_More_Than_Four",
    description_zh: "三之后，五之前，一个数字在这里成了禁忌，一旦脱口而出，人们便会莫名地恼怒，进而宣泄暴力。",
    description_ja: "三と五の間にある数字は、この地においてはタブーとされており、口にすれば人々は不可解な怒りを見せ、暴力を振るってくる。",
    description_en: "Following three, preceding five—a certain number has become taboo here. The mere mention enrages those present, and they will vent their anger with violence.",
    addInfo_zh: [
      "【路网】效果: 额外出现2个深池方阵指挥官"
    ],
    addInfo_ja: [
  ...
  },
  {
    ...
    description_ja: "かつて、よそ者たちは重機でこの森を破壊した。それから何年も経ったのち、外からやってきた人間たちはここで轟音を立てる幻影に怖気づいて逃げ出した。\n<@rolv.rem>戦場に破壊されると耐久値が1減る<コマンドシステム>が出現。</>",
    description_en: "Many years ago, foreigners devastated the woods with heavy machinery. Many years later, foreigners flee the woods frightened by phantom rumbling. \n<@rolv.rem>There are <Command Terminals> on the map that will deplete Life Points when destroyed</>",
    addInfo_zh: [
      "【路网】效果: 额外出现2个逐腐兽"
    ],
    addInfo_ja: [
  ...
  },
  {
    ...
    enemies: [
      ...
      },
      {
        ...
        prefabKey: "enemy_1096_ccwitch_2",
        level: 0,
        min_count: 0,
        max_count: 0,
        elite_min_count: 2,
  ...
  },
  {
    ...
    name_zh: "恃强凌弱",
    name_ja: "弱いものいじめ",
    name_en: "Harass_With_Strength",
    description_zh: "五个伐木工聚在一起诅咒他们的工友变成虫子。好消息是，工友们真变成了源石虫。坏消息是，今后他们再也没法看见人类了。",
    description_ja: "五人の木こりが集まって、同僚を虫に変える呪いを実行した。同僚たちは見事本当にオリジムシになったのだが、それと引き換えに、五人は二度とほかの人間の姿を目にすることもできなくなった。",
    description_en: "Five lumberjacks got together and cursed their fellow workers to turn into slugs. The good news is that the workers did indeed become Originium Slugs. The bad news is that they will never get to see humanity ever again.",
    addInfo_zh: [
      "【路网】效果: 额外出现2个匪帮射手",
        ...
        mods: {
          special: {
            bug_explode_eslime: {
              tooltip: {
                en: [
                  "Explodes on death, giving all enemies $+4$ energy and deals 400% ATK dmg to nearby units (Can be silenced)"
                ],
                ja: [
                  "死亡時には爆発する、マップ上の敵のエネルギーを$4$点補充して、周囲に攻撃力400%の術ダメージを与える（無効化可能）"
                ],
                zh: [
                  "死亡后使场上所有敌人获得$4$点能量，并对周围我造成攻击力400%的法术溅射伤害（可被沉默）"
                ]
              }
            }
          }
  ...
  },
  {
    ...
    name_zh: "冰凝之所",
    name_ja: "凍てついた地",
    name_en: "Where_Ice_Condenses",
    description_zh: "只要你血管里还有一丝温度，就不该到这里来，这里只属于冷血的人。",
    description_ja: "あなたにまだ温かな血が流れているのなら、ここに来るべきではない。ここは、冷血な人間にこそふさわしい場所なのだ。",
    description_en: "As long as there is even a trace of warmth flowing in your veins, you should not come here. For this place is only for the cold-blooded.",
    addInfo_zh: [
      "【路网】效果: 额外出现3个冰爆源石虫·α"
    ],
    addInfo_ja: [
  ...
  },
  {
    ...
    addInfo_zh: [
      "【环境】废能干扰 - 所有干员的技力恢复倍率-70%，且处于<重整束流>的我方干员技力恢复倍率+70%",
      "【路网】效果: 额外出现1个历战高塔术师和1个改进型量产巨像"
    ],
    addInfo_ja: [
      "【環境】異音の調べ - 味方全員のSP回復速度-70%、<指揮光線>を受けている味方のSP回復速度+70%",
      "「導きの網織」: 追加で<ベテラン高塔の術師>1体と<量産型巨像・改>1体が出現する"
    ],
    addInfo_en: [
      "Waste Energy Interference - Friendly units have SP Regen -70%, Friendly units linked with Realigned Fluxes have SP Regen +70%",
            ...
            ymmir_1: {
              ...
              tooltip: {
                en: [
                  ...
                  "after charging for 5s does 200% dmg to target and gains ASPD +$225$ for $30$s"
                ],
                ja: [
                  "スキル（初動10秒/再動35秒）",
                  "5秒間チャージした後、攻撃力の200%の術ダメージを与える",
                  "その後$30$秒間、自身の攻撃速度+$225$"
                ],
                zh: [
                  "技能（初次冷却10s，后35s）",
                  "蓄力约5s后，对目标造成攻击力200%的法术伤害，之后攻击速度+$225$，持续$30$s"
                ]
              }
            }
          }
  ...
  },
  {
    ...
    name_zh: "人造物狂欢节",
    name_ja: "人工物のカーニバル",
    name_en: "Manmade_Carnival",
    description_zh: "生人勿近！非人也勿近！机器们已经做了自己的主宰，把那些没芯片的碳基生物全部赶走！",
    description_ja: "人間も人間以外も立ち入り禁止だ！我らロボットは自由となる！チップが組み込まれていない有機生物をつまみ出せ！",
    description_en: "The living stay away! Non-persons also stay away! The machines have become their own masters, and are hunting down every carbon-based organism without a microchip!",
    addInfo_zh: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "湿气氤氲泛起，有轻柔的水流缠绕在你的脚底，这是来自河谷的问候。循着先祖的讲述，你欲将视线投向两百年前，而菈玛莲回你以笑靥。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "两百年前的敌人并未如约而至。你和女妖隔着面纱远远对望，你们对这座城市同样熟悉，你们对这座城市同样陌生。\n<@rolv.rem>场地中有产生食腐使徒的<汲营枯枝></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "她也许还想再看这城市一眼——明天，歌声将响起；后天，歌声将响起；大后天，亦然。她将歌唱。\n<@rolv.rem>场地中有产生食腐使徒的<汲营枯枝></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "他几乎没有亲口述说过事迹，但他的热情和他照料的引擎一样，从不停歇。循着先祖的讲述，你将视线投向两百年前，勇士却没有回头。\n<@rolv.rem>场地中有被摧毁时扣除目标生命值的<指挥终端></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+2"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "两百年前的敌人并未如约而至。勇士的大剑腾起火焰，这火焰是为了他的朋友而点燃，这火焰不会轻易被扑灭。\n<@rolv.rem>场地中有被摧毁时扣除目标生命值的<指挥终端></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+2"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "理想中的生活且留给后人实现。敌人排山倒海，家园危如累卵，歌利亚一往无前。\n<@rolv.rem>场地中有可以阻挡敌人行进路线的<碎石></>\n<@rolv.rem>场地中有使单位持续损失生命但大幅提升攻击力和攻击速度的<活性源石></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "忠臣，弄臣，朋友，敌人。先祖争论不休，而你将视线投向两百年前。这是存亡的一战，在你面前，凯尔希和她的同伴正刺破一道道阵线。\n<@rolv.rem>场地中有发射敌方佣兵无人机的<可移动战术机库></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通2/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "两百年前的英雄并未如约而至。贤人和她的仆从未有迟疑，直奔目标而去。你要迎接她们，末日驱使着她们。\n<@rolv.rem>场地中有发射敌方佣兵无人机的<可移动战术机库></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通2/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "再保卫以勒什的座辇和王冠一阵子吧，这不仅是为了战士们的尊严。这样，将来的贤人与魔王也不必因错过彼此而后悔。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "所有人立刻原地停下，放下手上所有事情。一门有关仪式操作安全的重要课程现在开始，不允许请假。\n<@rolv.rem>我方单位再部署时间减半</>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "百余年前，圣王会西部大堂在伦蒂尼姆的巨型天灾中被萨卡兹连同其他地块一起抢救到卡兹戴尔。那正是和解的开端，亦是和解的标志。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+2",
      "特蕾西娅，黑冠圣贤 - 初始攻击倍率50%，每次释放此技能后，攻击倍率+20%（最大倍率不超过500%）",
      "思维混乱时，击败特雷西斯，黑冠尊主后额外召唤精英敌人（7个裹骸死士）"
    ],
    addInfo_ja: null,
    addInfo_en: null,
    eliteDesc_zh: null,
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "圣城恢弘，圣城谐和，圣城慷慨，圣城庄严。圣城的守护者平等而慈悲地检视每一个入城者。接受圣城的，圣城都接受。\n<@rolv.rem>圣卫自动机攻击力大幅提升</>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+2"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "他跟着老板来到了卡兹戴尔，在一帮损友的怂恿下进城试胆。没有萨卡兹理会他，他自己快把自己吓哭了。\n<@rolv.rem>场地中有开启后使敌方隐匿失效的<侦测器></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "鸭爵不知道又动起了什么歪脑筋，安排了车辆去劫持平民。好在你提前知晓了他的计划，而且司机看起来并不清楚路线。\n<@rolv.rem>场地中有可以阻挡敌人行进路线，且可被我方攻击的<道路障碍物></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力，生命值+40%",
      "鸭爵获得额外防御力+40%，生命值+30%",
      "道路障碍物的生命值翻12倍",
      "出现的敌人产生巨大变化（有熊）"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+40%、防御力+40%、最大HP+40%",
      "「ダック卿」がさらに防御力+40%、最大HP+30%",
      "「道路障害物」の最大HP+1100%",
      "敵編成が大きく変わる (ゴプニクも出る)"
    ],
    eliteDesc_en: [
      "All enemy units have +40% ATK, +40% DEF, and +40% Max HP",
      "<Duck Lord> additionally gains +40% DEF and +30% Max HP",
      "<Static Roadblock>'s Max HP increased by 11x",
      "Enemy makeup changes greatly, <Gopnik> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "“这都是幻景，你们手里的东西拿不出大熔炉。”你想了想过去发生的事，放弃了这样劝诫他们，掏出了武器。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通2/紧急3/天灾+1"
    ...
    eliteDesc_ja: [
      ...
      "追加で「年代之刺」1個と「ダック卿」1体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +30% ATK, +30% DEF, and +30% Max HP",
      "Additional 1 <年代之刺> and 1 <Duck Lord> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "鸭爵在这里建造了交通客运站！他的朋友们浩浩荡荡而来！他没有卡兹戴尔的市政许可，也没出具环境影响评估报告！非法建筑必须拆除！\n<@rolv.rem>提供部署以后可以阻挡敌人的行进路线的<障碍物></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+4"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力+20%，生命值+30%",
      "4路全部出现敌人"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+30%",
      "全4ルートに敵が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +30% Max HP",
      "Enemies spawn at all 4 routes"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "不必发展到兵戎相见的机会是有的，没有发展到兵戎相见的例子也是有的。在这些例子里，当事人放下的不是武器，而是偏见。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+20%",
      "「人気キャンディカート」が倒されると「恐卡兹」を召喚する"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +20% Max HP",
      "All <Luscious Snack Cart> will spawn <恐卡兹> upon defeat"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "“它”自认是通道，“它”循着继承者的宣称而来。\n<@rolv.rem>场地中有产生食腐使徒的<汲营枯枝></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "人物和遭遇从你的眼前飞过，时间倒退，事件还原。为了另一种可能的结局，这些回溯是必要，是定数。但不应如此，这世上不应有定数。\n<@rolv.rem>场地中有持续施加【寒冷】效果的<源石冰晶></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "紧急警报被触发了。被遗弃的梦想及渴望操纵起同样被遗弃的破铜烂铁，决心保卫认可它们价值的人。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "通过想象创造出来的物品属于做出想象的人，而不属于捡拾物品的人。古德因纳夫先生却还试图狡辩，教给他道理吧。\n<@rolv.rem>场地中有可以阻挡敌人行进路线，且可被我方攻击的<道路障碍物></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "你想象了这份协议，你想象了他的签名，它们随即在熔炉幻景中化为现实——既然协议已经达成，你向古德因纳夫先生提出的主张就完全合理。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "所谓善恶同道，有时并非指善与恶的合作，而是指无论善恶，人们或许都要争夺一条道路。\n<@rolv.rem>选择对手进行战斗，失败不会扣除目标生命值，在限定时间内击败越难的对手将会获得更好的奖励</>",
    description_ja: null,
    description_en: null,
    addInfo_zh: null,
    addInfo_ja: null,
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "只要有条路留下，就无法阻挡彼此为敌者交锋；不留，就无法阻挡他们开辟这样一条路。\n<@rolv.rem>选择对手进行战斗，失败不会扣除目标生命值，在限定时间内击败越难的对手将会获得更好的奖励</>",
    description_ja: null,
    description_en: null,
    addInfo_zh: null,
    addInfo_ja: null,
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "一群流浪汉和他们养的动物一起霸占了这条维护通道，还对它擅加改造，完全不尊重他人意见。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力+10%，生命值+50%",
      "萨卡兹狙击手被替换为残党萨克斯手"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力、防御力+10%、最大HP+50%",
      "<サルカズ狙撃兵>が<残党のサックス奏者>に替わる"
    ],
    eliteDesc_en: [
      "All enemy units have +10% ATK, +10% DEF, and +50% Max HP",
      "All <Sarkaz Crossbowman> are replaced by <Remnant Saxophonist>"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "熔炉的热量吸引着十里八荒几乎所有还活着的小动物，它们想尽办法溜进来，之后兴奋地四处搞破坏。\n<@rolv.rem>场地中有激活后短暂持续造成法术伤害的<废热喷口></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_en: [
      "All enemy units have +20% ATK, +50% Max HP",
      "Only bottom <Waste Heat Vent> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "巫妖们规定，养护工人们下班离开熔炉时必须接受检查，清点人数——不能少，更不能多。这个规定并不总能得到执行。\n<@rolv.rem>场地中有使单位持续损失生命但大幅提升攻击力和攻击速度的<活性源石></>\n<@rolv.rem>场地中有发射敌方佣兵无人机的<可移动战术机库></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+30%",
      "追加で「萨卡兹迷宫归乡者」1体が出現し、かつ最大HPがさらに30%上昇"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF and +30% Max HP",
      "Additional 1 <萨卡兹迷宫归乡者> appears and all <萨卡兹迷宫归乡者> have additional +30% Max HP"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "这些监守自盗的萨卡兹想从熔炉里捞点宝贝出来，但他们先被“宝贝”发现了。追逐之下，任何路都成了生路。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_zh: [
      "所有敌方单位的攻击力+20%，生命值+50%",
      "额外出现1个萨卡兹大剑手和2个萨卡兹刀兵"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、最大HP+50%",
      "追加で「サルカズ大剣士」1体と「サルカズ刀術師」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, and +50% Max HP",
      "Additional 1 <Sarkaz Greatswordsman> and 2 <Sarkaz Swordsman> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "由知识圣殿定期举办。留在熔炉内的巫妖们绘声绘色地诉说着种种可怕见闻，规劝其他参会者从熔炉的内部离开。每次都没人离开。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "熔炉养护工作技巧其一：坏了就先拆了——如果是需要修补的东西，那自会有人来修补。\n<@rolv.rem>场地中有可以消耗一定部署费用开启，晕眩周围敌人的<震撼装置></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/紧急1/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "从魂灵熔炉排风口外的平台跳下，顺风滑翔，十个年轻萨卡兹里面有九个都夸口说做过。其实那些“平台”压根没铺地板。\n<@rolv.rem>场地中有喷出气流的<源石流发生装置></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+50%",
      "「切り込み隊長」がステルスを獲得"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF and +50% Max HP",
      "<Breaker Leader> gains stealth"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "他们正赶着下班，因为太着急，他们走错了卡兹戴尔。\n<@rolv.rem>场地中有对敌我造成伤害的<源石祭坛></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的防御力+20%，生命值+70%",
      "游击队萨卡兹战士被替换为游击队萨卡兹战士组长"
    ],
    eliteDesc_ja: [
      "敵全員の防御力+20%、最大HP+70%",
      "「遊撃隊サルカズ戦士」が「遊撃隊サルカズ戦士隊長」に替わる"
    ],
    eliteDesc_en: [
      "All enemy units have +20% DEF and +70% Max HP",
      "All <Sarkaz Guerrilla Fighter> are replaced with <Sarkaz Guerrilla Fighter Leader>"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "在搞清发生了什么之后，这些萨卡兹开始争论谁的卡兹戴尔更好。他们请你仲裁，在得到令人信服的结果前，他们不会离开。\n<@rolv.rem>场地中有使我方不会成为敌人远程攻击目标的<排气格栅></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+40%",
      "追加で「技術偵察兵」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF and +40% Max HP",
      "Additional 2 <Technical Scout> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "因为谁都不愿意做模仿“外敌”的那一方，这种演练总会变成由萨卡兹对阵萨卡兹。\n<@rolv.rem>场地中有使我方单位防御力减半的<腐蚀地面></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力+20%，防御力+30%",
      "出现伦蒂尼姆城防副炮",
      "伦蒂尼姆城防副炮 - 初始60SP/消耗120/自动回复",
      "锁定阻挡数最高的我方单位，对范围内的全部单位造成3000点真实伤害（无视隐匿/迷彩）"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+30%",
      "「ロンディニウム都市防衛副砲」が起動される",
      "「ロンディニウム都市防衛副砲」 - 初期SP60/必要SP120/自動回復",
      "ブロック数の最も大きい味方ユニットを対象に砲撃を行う、砲撃は対象を中心とした範囲に存在する敵味方双方の全ユニットに3000の確定ダメージを与える（ステルス・迷彩無視）"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK and +30% DEF",
      "<Londinium Secondary Defense Artillery> is activated",
      "<Londinium Secondary Defense Artillery> - Initial SP 60, SP Cost 120, Auto Recovery",
      "Once fully charged, deals 3000 splash True damage to both allies and enemies, centered on the friendly unit with the highest Block (ignores stealth and camouflage)"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "于哪个历史时期，提卡兹经历了何种分化——这是知识圣殿的经典辩题，每隔一段时间就有新的可能性被“发明”出来。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通2/天灾+1"
    ...
    eliteDesc_zh: [
      "所有敌方单位的攻击力+20%，生命值+50%",
      "1个萨卡兹枯朽战士被替换为1个萨卡兹枯朽吞噬者和4个高能源石虫",
      "年代之刺换位置"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、最大HP+50%",
      "「枯朽サルカズ戦士」1体が「枯朽サルカズ吸収者」1体と「バクダンムシ」4体に替わる",
      "「年代之刺」の位置が変わる"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK and +50% Max HP",
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "卡兹戴尔的升降机总是排着不短的队，食腐者们会对付那些想混进城的不速之客，他们的召唤物也能顺便给大家遮阳。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    eliteDesc_en: [
      "All enemy units have +70% DEF and +20% Max HP",
      "All <Seed of Withering> have +50% ATK"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "城市里，晶簇生长不停，收割晶体就成了萨卡兹们每天早上的习惯。有早点吃的就吃完早点去，没早点吃的醒了就去。\n<@rolv.rem>场地中有可以阻挡敌人行进路线的<碎石></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力+30%，生命值，移动速度+50%",
      "碎石的生命值-50%"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+30%、最大HP+50%、移動速度+50%",
      "「礫岩」の最大HP-50%"
    ],
    eliteDesc_en: [
      "All enemy units have +40% ATK, +20% DEF and +50% Max HP",
      "All <Rubble> have -50% Max HP"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "烹饪时，如果不对炉火善加看护，很容易酿成事故；用巫术召唤佣仆也是一样。而这两则常识总有萨卡兹会忘记。\n<@rolv.rem>场地中有对敌我造成伤害的<源石祭坛></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+2"
    ...
    eliteDesc_en: [
      "All enemy units have +40% ATK, +20% DEF and +50% Max HP",
      "Additional 2 <Originium Altar> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "见多识广的外地返乡萨卡兹找乐子时发明的。谁被“开出来”，谁就上去干架。虽然总会变成群殴，但大家开心就好了嘛。\n<@rolv.rem>场地中有阻挡敌人的<城防路障></>\n<@rolv.rem>场地中有持续施加【寒冷】效果的源石冰晶。</>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "时间放开了时间的手，萨卡兹记忆中的事物开始交替出现在岁月的间隙中。\n<@rolv.rem>场地中有提供费用及上限的<街头应急储备></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "初始部署费用上限降低至30",
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力，生命值+50%",
      "额外出现2个萨卡兹悖谬暴虐兵长"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+50%、防御力+50%、最大HP+50%",
      "追加で「サルカズ悖理暴虐兵士長」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +50% ATK, +50% DEF and +50% Max HP",
      "Additional 2 <Sarkaz Absurdist Tyrant Captain> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "幻景因巫术繁盛，亦因巫术枯朽。为了保证该到来的到来，该离去的离去，巫术的平衡在所有年代中都受到严密的监管。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通3/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力+50%，防御力+20%，生命值+100%"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+50%、防御力+20%、最大HP+100%"
    ],
    eliteDesc_en: [
      "All enemy units have +50% ATK, +20% DEF and +100% Max HP"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "不知从何而来的杜林向破烂拼凑者学习了近地飞行的本领，在卡兹戴尔的城市缝隙间乐此不疲地比赛飞行，反正失事也只是摔一头包。\n<@rolv.rem>场地中有阻挡敌人的<城防路障></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力+50%，生命值+50%",
      "额外出现2个萨卡兹迷宫归乡者"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+50%、最大HP+50%",
      "追加で「萨卡兹迷宫归乡者」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +50% ATK, and +50% Max HP",
      "Additional 2 <萨卡兹迷宫归乡者> appear"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "这条甬道不日将通往血魔的灵庙，它却并非以鲜血浸染。正因如此，鲜血的子裔争先恐后地想要浸染它。\n<@rolv.rem>场地中有间断对其上单位造成伤害的<热泵通道></>\n<@rolv.rem>场地中有阻挡敌人的<城防路障></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、最大HP+50%",
      "作戦開始時追加で「サルカズ眷属補給車」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, and +50% Max HP",
      "Additional 2 <Sarkaz Heirbearer ASV> appear at the start"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: '距离《与萨卡兹的共同宣言》发表已有几个月。相关各方准备就绪，这个新的血盟将迎来第一场战火的考验。\n<@rolv.rem>场地中有吸收实验产物激活的<动力装甲></>\n<@rolv.rem>场地中有夺取后可以治疗友方单位并对敌方造成法术伤害的<"留声机"></>',
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_zh: [
      "所有敌方单位的攻击力+20%，生命值+50%",
      "额外出现3个莱塔尼亚轻语者，2个R-11突击动力装甲"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、最大HP+50%",
      "追加で「リターニア術師」3体、「R-11突撃型パワードスーツ」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, and +50% Max HP",
      "Additional 3 <Leithanian Whisperer> and 2 <R-11 Assault Power Armor> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "一些古老的萨卡兹被他们从未见过的机械惹恼了，可那些机械的外壳上似乎也铭刻着卡兹戴尔的标记。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    eliteDesc_ja: [
      ...
      "「圣卫自动机」が倒されると「恐卡兹」を召喚する"
    ],
    eliteDesc_en: [
      "All enemy units have +25% ATK, +25% DEF and +25% Max HP",
      "All <圣卫自动机> will spawn <恐卡兹> upon defeat"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "传说有位死魂灵附身于某处古老的移动地块之上，至今游荡在大地某处。你眼前的会是那个地块吗？上面生活着怎样的居民？\n<@rolv.rem>场地中有产生食腐使徒的<汲营枯枝></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_en: [
      "All enemy units have +30% ATK and +50% Max HP",
      "<'Twigs That Crave'> have +100% Max HP"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "为了生计，佣兵去了伦蒂尼姆。但你坚定地相信，她和之后焚毁全城的大火没有任何关系。\n<@rolv.rem>场地中有周期对目标区域造成真实伤害的<伦蒂尼姆城防副炮></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+2",
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力+40%，防御力+50%，生命值+20%",
      "额外出现12个乌萨斯平民，3个萨卡兹子裔工匠，2个萨卡兹王庭军术师"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+40%、防御力+50%、最大HP+20%",
      "追加で「ウルサス民間人」12体、「サルカズ眷属工匠」3体と「サルカズ王庭軍術師」2体が出現する"
    ],
    eliteDesc_en: [
      "All enemy units have +40% ATK, +50% DEF and +20% Max HP",
      "Additional 12 <Ursus Civilian>, 3 <Sarkaz Heirbearer Artificer> and 2 <Sarkaz Royal Court Caster> appear"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "萨卡兹垦荒的方法很简单——用火炮轰炸几轮即可。萨卡兹们要吃饭，有人误入垦荒规划区并不构成变更计划的理由。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+50%、最大HP+50%",
      "「都市防衛自走砲」のスキルクールタイムが半減"
    ],
    eliteDesc_en: [
      "All enemy units have +50% ATK and +50% Max HP",
      "<Londinium Mobile Defense Artillery>'s skill CD halved"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "在皇帝和大贵族的带领之下，莱塔尼亚人逐渐融入了萨卡兹的生活。而这份真诚的友谊将交换到惊人的秘密。\n<@rolv.rem>场地中有受击后可开启，切换变奏并使我方获得短暂增益的<调谐节点></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "始终是<@purple>沉郁变奏</>，能用调谐节点改换变奏",
      "年代之刺：普通0/天灾+1"
    ],
    addInfo_ja: null,
    addInfo_en: null,
    ...
    eliteDesc_en: [
      "All enemy units have +30% ATK, +20% DEF, and +30% Max HP",
      "Tuning Node's skill activation SP cost doubled"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "这条通道必须封锁，疏漏的可能性必须被杜绝在熔炉内。幻景之中亦有真实，幻景创造真实，不可掉以轻心。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1",
    ...
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力+20%，生命值+50%",
      "腐败骑士，凋零骑士狂暴后攻击力加成提升至130%"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+50%",
      "「腐敗騎士」と「凋零騎士」が凶暴化した時の攻撃力上昇が130%になる"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +50% Max HP",
      "<Corrupted Knight> and <Withered Knight>'s ATK gain when enraged increased to 130%"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力，生命值+20%",
      "初始最右边的1个渎罪奇美拉被替换为萨卡兹恶咒者"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+20%",
      "右端にいる「渎罪奇美拉」1体が「サルカズ呪術隊長」に替わる"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +20% Max HP",
      "The rightmost <渎罪奇美拉> is replaced with <Sarkaz Worldcurser>"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "卡兹戴尔的“地块”航行在天空之中，但遗憾的是，这并不代表它就可以免于遭受敌对城市的袭击。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+1"
    ...
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +20% Max HP",
      "Additional 1 <Withering Collector Disciple> appears"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "某个夜里，这所学院的一部分先后掉入了众多卡兹戴尔的缝隙中。未被波及的学者教授们第二天因机会不愿选中他们而纷纷捶胸顿足。\n<@rolv.rem>场地中有使我方不会成为敌人远程攻击目标的<排气格栅></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通1/天灾+1"
    ...
    eliteDesc_ja: [
      "敵全員の攻撃力+30%、防御力+30%、最大HP+30%",
      "「萨卡兹迷宫织咒者」のスキルクールタイムが半減"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +20% Max HP",
      "<萨卡兹迷宫织咒者>'s skill CD halved"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "大部分先祖的讨论正在向同一个可能性聚合，而另一些则更为激烈地表达反对。幻景之中，代表反对者的形象开始涌向你。",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+2"
    ...
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力，生命值+20%",
      "魂灵涡流的防御力+400，移动速度+0.3"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+20%、防御力+20%、最大HP+20%",
      "「魂灵涡流」の防御力+400、移動速度+0.3"
    ],
    eliteDesc_en: [
      "All enemy units have +20% ATK, +20% DEF, and +20% Max HP",
      "<魂灵涡流> have additional +400 DEF, +0.3 Movespeed"
    ],
    elite_mods: [
      {
        targets: [
  ...
  },
  {
    ...
    name_ja: null,
    name_en: null,
    description_zh: "圣城之外，对于提卡兹而言最神圣的两大渴求如下：第一，被圣城接受；第二，进入圣城。路上的冰淇淋机可以满足他们剩下的渴求。\n<@rolv.rem>场地中有夺取后回复周围友方单位技力的<“冰淇淋机”></>",
    description_ja: null,
    description_en: null,
    addInfo_zh: [
      "年代之刺：普通0/天灾+2"
    ...
    addInfo_en: null,
    eliteDesc_zh: [
      "所有敌方单位的攻击力，防御力+30%，生命值+40%",
      "寻路者阵地破坏者与寻路者阵地撕裂者对“冰淇淋机”的伤害翻倍"
    ],
    eliteDesc_ja: [
      "敵全員の攻撃力+30%、防御力+30%、最大HP+40%",
      "「求道ブレイカー」と「精鋭求道ブレイカー」が「ジェラート供給所」に与えるダメージが2倍になる"
    ],
    eliteDesc_en: [
      "All enemy units have +30% ATK, +30% DEF, and +40% Max HP",
      "<Pathfinder Ballistarius> and <Pathfinder Ballistarius Prefect> deals twice the damage to Gelato Stops"
    ],
    elite_mods: [
      {
        targets: [
...
export { GET };
//# sourceMappingURL=_server-d65af8d7.js.map
